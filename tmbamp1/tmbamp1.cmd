...
# Start of element U5
ChangePinName(U5, 8, N/C)
ChangePinName(U5, 21, GND)
ChangePinName(U5, 18, GND)
ChangePinName(U5, 12, GND)
ChangePinName(U5, 11, GND)
ChangePinName(U5, 10, GND)
ChangePinName(U5, 13, VDD)
ChangePinName(U5, 9, VDD)
ChangePinName(U5, 6, VDD)
ChangePinName(U5, 14, RFout)
ChangePinName(U5, 7, N/C)
ChangePinName(U5, 20, C0.5)
ChangePinName(U5, 19, C1)
ChangePinName(U5, 17, C2)
ChangePinName(U5, 16, C4)
ChangePinName(U5, 15, C8)
ChangePinName(U5, 1, C16)
ChangePinName(U5, 5, LE)
ChangePinName(U5, 4, Clock)
ChangePinName(U5, 3, Data)
ChangePinName(U5, 2, Rfin)
