...
# Start of element U3
ChangePinName(U3, 11, TP)
ChangePinName(U3, 8, PGND)
ChangePinName(U3, 4, GND)
ChangePinName(U3, 10, SW)
ChangePinName(U3, 1, L)
ChangePinName(U3, 5, FB)
ChangePinName(U3, 9, OUT)
ChangePinName(U3, 3, SS)
ChangePinName(U3, 7, FSW)
ChangePinName(U3, 6, EN)
...
# Start of element U5
ChangePinName(U5, 9, PowerPAD)
ChangePinName(U5, 7, DNC)
ChangePinName(U5, 3, NC)
ChangePinName(U5, 2, FB)
ChangePinName(U5, 1, OUT)
ChangePinName(U5, 4, GND)
ChangePinName(U5, 6, NR/SS)
...
# Start of element U6
ChangePinName(U6, 7, out)
ChangePinName(U6, 6, in-)
ChangePinName(U6, 5, in+)
...
# Start of element U7
ChangePinName(U7, 5, V-)
ChangePinName(U7, 2, V+)
ChangePinName(U7, 1, out)
ChangePinName(U7, 4, in-)
ChangePinName(U7, 3, in+)
...
ChangePinName(U4, 4, VOUT)
ChangePinName(U4, 1, VDD)
ChangePinName(U4, 7, DIN)
ChangePinName(U4, 6, SCLK)
ChangePinName(U4, 5, \_SYNC\_)
